function [U_new, center, obj_fcn] = stepfcm2dmf(data,data1, dims, U, cluster_n,...
    expo, mfw, spw, nwin)
%STEPFCM One step in fuzzy c-mean image segmentation with spatial constraints;

mf = U.^expo;   % MF matrix after exponential modification

% data1=[0.45 0.566 0.6760 0.354 0.5675];
% data=data';
...
tmp = dist.^(-2/(sum(data1)-1));      % calculate new U, suppose expo != 1
